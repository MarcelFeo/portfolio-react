...
export default function About() {
  ...
  return (
    <>
      ...
      <Container>
        <Text>
          Meu nome é Marcel Féo, tenho {year - 2004} anos e atualmente sou autodidata. Recentemente, tenho me apaixonado cada vez mais pela área de Desenvolvimento Web então venho participando de muitos eventos e também frequentemente faço cursos novos em assuntos de programação Front-End e design UI/UX, a fim de manter-me atualizado sobre os mais recentes métodos e tecnologias disponíveis para realizar as minhas aplicações e otimizar os sistemas e processos.
        </Text>
